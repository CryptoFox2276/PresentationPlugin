...
public class SecondScreenPresentation extends Presentation {
	...
	private static String DEFAULT_DISPLAY_HTML = "<!DOCTYPE html><html><head><style>body {background-image: url('https://i.postimg.cc/QxRDc5c1/landscape2.png');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;}h1 {margin: auto;color: white;position: absolute;top: 50%;width: 100%;text-align: center;}</style></head><body><h1>Secondary Screen Page</h1></body></html>";
